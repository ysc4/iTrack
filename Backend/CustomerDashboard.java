...
public class CustomerDashboard extends JPanel {
	...
	public static double customerGrowth() throws Exception {
	    ...
	    double customers2023 = 0;
	    double customers2024 = 0;
        for (Document doc : results) {
        	customers2023 = doc.getInteger("customers2023");
        	customers2024 = doc.getInteger("customers2024");
        } 
        
        double totalGrowth = computeIncrease(customers2024, customers2023);
        mongo.close();
        return totalGrowth;
    ...
    public static double computeIncrease(double current, double previous) {
		if (previous != 0) {
